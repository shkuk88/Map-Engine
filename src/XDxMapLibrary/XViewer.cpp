...
bool	XViewer::Frame(const float& spf, const float& accTime) noexcept
{
	m_fTick += spf * m_Scene.m_iFrameSpeed * m_Scene.m_iTickPerFrame * m_fTickSpeed;
...
bool	XViewer::Render(ID3D11DeviceContext* pContext) noexcept
{
	PreRender(pContext);
