...
HRESULT XSpreatController::CreateSpreatTexture()
{
	...
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_SpreatTexture);
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_AlphaTexture[0]);
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_AlphaTexture[1]);
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_AlphaTexture[2]);
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_AlphaTexture[3]);
	...
	hr = DxManager::Get().GetDevice()->CreateTexture2D(&m_TextureDesc, NULL, &m_StagingTexture);
